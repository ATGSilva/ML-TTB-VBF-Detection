...
VBFH, SNU, TTBAR = [], [], []
# CATEGORIES = ["VBFH_numpy", "TTBAR_numpy","SNU_numpy"]
CATEGORIES = ["TTBAR_numpy","SNU_numpy"]
...
def create_training_data_lists(DATADIR = "."):
...
TTBAR_t, TTBAR_ev = partition_lists(TTBAR, main=75, reserve=25)
# VBFH_t, VBFH_ev = partition_lists(VBFH)
SNU_t, SNU_ev = partition_lists(SNU, main=75, reserve=25)

training_data = SNU_t + TTBAR_t
external_validation_data = SNU_ev + TTBAR_ev 
...
pickle_out = open("test_training_x.pkl","wb")
pickle.dump(x, pickle_out)
pickle_out.close()

pickle_out = open("test_training_y.pkl","wb")
...
pickle_out = open("test_validation_x.pkl","wb")
pickle.dump(x_val, pickle_out)
pickle_out.close()

pickle_out = open("test_validation_y.pkl","wb")
